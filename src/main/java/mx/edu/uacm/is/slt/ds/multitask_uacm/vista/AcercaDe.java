...
public class AcercaDe {
    ...
    // Constructor simple de inicializacion
    ...
    // Carga la vista del FXML correspondiente
    private void cargarVista() {
        try {
            ...
            // Destruye el singleton local al cerrar la ventana
    ...
    // Despliega de forma unica la ventana informativa del sistema
